...
extern struct xscreensaver_function_table
 ...
 worldpieces_xscreensaver_function_table,
 ...
 xshadertoy_xscreensaver_function_table,
...
NSDictionary *make_function_table_dict(void) {
  return @{
	...
	@"Battered Planet":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Beats":	[NSValue valueWithPointer:&beats_xscreensaver_function_table],
	@"Be Still":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Bubble Colors":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Dark Transit":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Downfall":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Drift":	[NSValue valueWithPointer:&drift_xscreensaver_function_table],
	@"Drift Clouds":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Elemental Ring":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Gimbal Harmonics":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Hex Plasma":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Logarithmic Circles":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Neon Gravity":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Neon Triangulator":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Nox Fire":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Proc Ocean":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Projective Plane":	[NSValue valueWithPointer:&projectiveplane_xscreensaver_function_table],
	@"Protophore":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Rig Rekt":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Self Reflect":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Skyline":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Star Dome":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Starfish":	[NSValue valueWithPointer:&starfish_xscreensaver_function_table],
	@"Star Nest":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Stripey Torus":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Synthwave City":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Topologica":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Train Mandala":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	@"Triangle":	[NSValue valueWithPointer:&triangle_xscreensaver_function_table],
	@"Trizm":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Truchet Zoom":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"Universe Ball":	[NSValue valueWithPointer:&xshadertoy_xscreensaver_function_table],
	...
	@"World Pieces":	[NSValue valueWithPointer:&worldpieces_xscreensaver_function_table],
